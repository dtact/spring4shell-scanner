...
var signatures = map[string][]string{
	...
	// Added prefix 'scf-' to tell apart Spring Cloud Functions from the regular Spring Core/Beans binaries
	//
	// for i in */*.jar; do shasum -a 256 $i | awk -F'[ /]' '{ print "\"scf-" $3 "\": []string\{\"" $1 "\"\}," }'; done;
	"scf-1.0.0.RELEASE":  []string{"cb54366f8440d0a2a206742f0c99eea5dec626b48a2535a85e03aaa775f982e5"},
	"scf-1.0.1.RELEASE":  []string{"6ee81cb25039642396517c5d15470acc5c93c89a49452e3ad109f1245e8a6a0a"},
	"scf-1.0.2.RELEASE":  []string{"a27bde9369210e2f6e2453b8b40ab6596a4a7108c691cd796aef608280fc23eb"},
	"scf-2.0.0.RELEASE":  []string{"6cd2cd043040a9bf9823e25d4eb1a75f66da792ca699a3b89cb44284d978bf31"},
	"scf-2.0.1.RELEASE":  []string{"9c9531ea7517612555e711fae63017e1086c801febce131ba40d54376999bcfe"},
	"scf-2.0.2.RELEASE":  []string{"0e6894fde85af13da17b7938c4fad7d153c30e256c97fb476cdfbf35ac7ef000"},
	"scf-2.1.0.RELEASE":  []string{"63a28523933a10a0d8cc7df944b61ee3f0c52741ab8bdf6d7038d8d181b4a4ff"},
	"scf-2.1.1.RELEASE":  []string{"b7611c96a97b7e9174c0b7d77627c49bea9609887e1608c10f713101018b4bb6"},
	"scf-3.0.0.RELEASE":  []string{"ed800f7ed9005a1cdab19ad0694a0ad3137f9421850beab3709dbeabab5d2a25"},
	"scf-3.0.1.RELEASE":  []string{"f42cc6aee9b78d996ae1b2e763c325a543dde11dcaefd005acfea3be9e86065e"},
	"scf-3.0.10.RELEASE": []string{"06fe7d2dc2c5628319079a7088532fee5b768e91aeed77c0a567da00dd0a176d"},
	"scf-3.0.11.RELEASE": []string{"7e803aa3f9341975d0d7d1a2e00803afb6a9eca3f27ab6df883f1316c1a83f66"},
	"scf-3.0.12.RELEASE": []string{"a3436f618aa4bd6c0fe6ac5c935e0f54c33c0a738ef3f810f82b12ebc15851ac"},
	"scf-3.0.13.RELEASE": []string{"d8d081befb0edd29188883a543abcac04461a5bc77dba03dd58a638e07509981"},
	"scf-3.0.14.RELEASE": []string{"883fc5069fd85a62d28572d6d05586a358acfed9a0224ee4d5ecceefa4a1ad62"},
	"scf-3.0.2.RELEASE":  []string{"51a5a34da65a4ea44147ec1ba15f393ce542ad043331d4f027c8677bef13dc5b"},
	"scf-3.0.3.RELEASE":  []string{"96eeb8039a1bd2400663b1bc9dbc8f7a5bd01c5939d21b52254251c708784b3a"},
	"scf-3.0.4.RELEASE":  []string{"316d38860ccdad3ab05756d9bfb6adcda94f46c1a60057cd89c7fff4fc906547"},
	"scf-3.0.5.RELEASE":  []string{"25171101cbe9024a4abfb81836b18cec3a9d69b72d293040ca5001d383bcf412"},
	"scf-3.0.6.RELEASE":  []string{"0f2c471b819cf65fba9704725165e34a24207d4a1688528ae4f92409c2c2c742"},
	"scf-3.0.7.RELEASE":  []string{"1c3295cc69571fa1389050ab395b114ec4b07e38f10136e0e1342eb598282ba9"},
	"scf-3.0.8.RELEASE":  []string{"4f3e2ea30fc4a0b4d532e5246fe59ad966c91ac287af7d74024e8a7cda2052a7"},
	"scf-3.0.9.RELEASE":  []string{"a3b42ef2648a8fc05c270a33a5a4e7b407688998d452ded9c96983664f48a2c2"},
	"scf-3.1.0":          []string{"b454b8d90460c6802488e1b381c419cc371b6d480caefcf390bfdb0638437b2a"},
	"scf-3.1.1":          []string{"182b013007224a1503b2baab53bcafe642e5b7a7bd8029a3260cfbf680b1e9e2"},
	"scf-3.1.2":          []string{"3ae7dfe54d4cd1533ab122e32935b85a00ac2efb20a077eb260991d32c1df6a9"},
	"scf-3.1.3":          []string{"cffbe4fa1fb7fbf7e713aa6ea095b21c37ef845cc12c7ec02d0b472cd30be235"},
	"scf-3.1.4":          []string{"91dd6fdd67cc69efe0d10a2130a83815477c3c033a226c991bfe1bba07945ff0"},
	"scf-3.1.5":          []string{"1b07bf3b55d844108670e2d0f42cfe378fbe5ce3b2fd4d577440050182a2f2b1"},
	"scf-3.1.6":          []string{"c0ef37245f521774f9e540bc258981c5931e4c462b246fd452c52f861ebad47b"},
	"scf-3.2.0":          []string{"ae74abd31a01574bf957ad05a51dcc6180af0490dc4701da112e82abc2c718a5"},
	"scf-3.2.1":          []string{"909f893ff5db017e1a5181c26672659b38669ee0967caed8998816fc6aac761a"},
	"scf-3.2.2":          []string{"0ad4b649e1b464de0349743cc3a67d6bd0c805579e879b7c53032ad5c01373d6"},
}
...
var fileSignatures = []struct {
	...
	// for i in $(find . | grep RoutingFunction.class); do shasum -a 256 "${i}" | awk -F'[ /]' '{ print "\{\"RoutingFunction.class\", \"" $1 "\", \"scf-" $4 "\"\}," }'; done
	{"RoutingFunction.class", "14ae35dcb37f1bd351c66772e87a9d02bd261108a02352fc41a532267c006b57", "scf-3.0.0.RELEASE"},
	{"RoutingFunction.class", "14ae35dcb37f1bd351c66772e87a9d02bd261108a02352fc41a532267c006b57", "scf-3.0.9.RELEASE"},
	{"RoutingFunction.class", "c907520d55f8033131f9e63db780445ed07ea5ea95120bed22b66c702e7df019", "scf-3.1.2"},
	{"RoutingFunction.class", "c907520d55f8033131f9e63db780445ed07ea5ea95120bed22b66c702e7df019", "scf-3.1.5"},
	{"RoutingFunction.class", "14ae35dcb37f1bd351c66772e87a9d02bd261108a02352fc41a532267c006b57", "scf-3.0.8.RELEASE"},
	{"RoutingFunction.class", "c907520d55f8033131f9e63db780445ed07ea5ea95120bed22b66c702e7df019", "scf-3.1.4"},
	{"RoutingFunction.class", "c907520d55f8033131f9e63db780445ed07ea5ea95120bed22b66c702e7df019", "scf-3.1.3"},
	{"RoutingFunction.class", "14ae35dcb37f1bd351c66772e87a9d02bd261108a02352fc41a532267c006b57", "scf-3.0.1.RELEASE"},
	{"RoutingFunction.class", "14ae35dcb37f1bd351c66772e87a9d02bd261108a02352fc41a532267c006b57", "scf-3.0.3.RELEASE"},
	{"RoutingFunction.class", "cb2aabf3315ed60f2a89899d29e628c150e23692f730a061da9cbca0e816569a", "scf-3.0.14.RELEASE"},
	{"RoutingFunction.class", "eed9e010b941e146eb80dc5a942b66b559862a6c6b0d844aadb13808b28bd451", "scf-3.2.2"},
	{"RoutingFunction.class", "14ae35dcb37f1bd351c66772e87a9d02bd261108a02352fc41a532267c006b57", "scf-3.0.2.RELEASE"},
	{"RoutingFunction.class", "14ae35dcb37f1bd351c66772e87a9d02bd261108a02352fc41a532267c006b57", "scf-3.0.11.RELEASE"},
	{"RoutingFunction.class", "14ae35dcb37f1bd351c66772e87a9d02bd261108a02352fc41a532267c006b57", "scf-3.0.7.RELEASE"},
	{"RoutingFunction.class", "14ae35dcb37f1bd351c66772e87a9d02bd261108a02352fc41a532267c006b57", "scf-3.0.10.RELEASE"},
	{"RoutingFunction.class", "14ae35dcb37f1bd351c66772e87a9d02bd261108a02352fc41a532267c006b57", "scf-3.0.6.RELEASE"},
	{"RoutingFunction.class", "8d61a523c4148814532e9d017e7d20d93ea7d1c92e8c0c645658443344a739ce", "scf-3.1.6"},
	{"RoutingFunction.class", "a6accf29f5e4e39a85a3994d8504fd9914370bf9f3d5eec021ae912fb0f8379f", "scf-3.1.1"},
	{"RoutingFunction.class", "efd54db2da5181f6b25546a971bfd84939fae7994d75cd9f36e684b9f6064449", "scf-3.1.0"},
	{"RoutingFunction.class", "14ae35dcb37f1bd351c66772e87a9d02bd261108a02352fc41a532267c006b57", "scf-3.0.4.RELEASE"},
	{"RoutingFunction.class", "3ba1a16fb3a69b7fb5014d52254c9b4fd4ff07b987276ca8bc4dd962c4412b90", "scf-2.1.1.RELEASE"},
	{"RoutingFunction.class", "14ae35dcb37f1bd351c66772e87a9d02bd261108a02352fc41a532267c006b57", "scf-3.0.12.RELEASE"},
	{"RoutingFunction.class", "0bce6003ef4a9777f4cfa9ad8455c6a4ff1df016f4f975478d8db053a5323406", "scf-3.2.1"},
	{"RoutingFunction.class", "14ae35dcb37f1bd351c66772e87a9d02bd261108a02352fc41a532267c006b57", "scf-3.0.5.RELEASE"},
	{"RoutingFunction.class", "cb2aabf3315ed60f2a89899d29e628c150e23692f730a061da9cbca0e816569a", "scf-3.0.13.RELEASE"},
	{"RoutingFunction.class", "0bce6003ef4a9777f4cfa9ad8455c6a4ff1df016f4f975478d8db053a5323406", "scf-3.2.0"},
	{"RoutingFunction.class", "14b5d27d1c20360e824d132bc62f7ff032b5b357ba4856eab4dfd18812891bfc", "scf-2.1.0.RELEASE"},
}
